...
| **Vosk-TTS ru-multi** | `vosk-vits` | ✅ нативный, словарные ударения | да (1 ONNX ~70 МБ + словарь) | **поддерживается** | alphacep, 5 голосов (3 жен./2 муж.), 22 кГц, RTF<1. `tools/vosk_tts_package_colab.ipynb`; движок `VoskTtsEngine` (порт g2p_noembed, модели 0.7-multi без BERT) |
